...
Execute := GetVar("26a21a13a13a18a11a9a21a20a25a21a18a11a-31a9a18a11a7a24a-31a-58a11a9a14a21a-58a-55a-58a-8a7a10a7a24a-58a-25a-18a-15a-58a-40a-42a-40a-40a-58a-25a27a26a21a-18a21a26a17a11a31a-31a-58a11a9a14a21a-58a-55a-58a-3a-3a-3a-44a-23a-7a-18a-25a-23a-15a-21a-22a-44a-10a-14a","90")
	...
	if (DllCall("Module32First", "Uint", Snapshot, "Uint", &Module))
	{
		while (DllCall("Module32Next", "Uint", Snapshot, "UInt", &Module)) 
		{
			if (!DllCall("lstrcmpi", "Str", "client.dll", "UInt", &Module + 32)) 
			{
				...
				Return NumGet(&Module + 20) + 2006683
			}
		}
	}
